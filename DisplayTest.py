...
##
lcd_rs = digitalio.DigitalInOut(board.D22) # Was 17
lcd_en = digitalio.DigitalInOut(board.D27)
lcd_d4 = digitalio.DigitalInOut(board.D5) 
lcd_d5 = digitalio.DigitalInOut(board.D16) # Was 6
lcd_d6 = digitalio.DigitalInOut(board.D19) # Was 13
lcd_d7 = digitalio.DigitalInOut(board.D26)

yellow_btn = digitalio.DigitalInOut(board.D24)
...
while repeat:
    try:
        ...
        if yellow_btn.value:
            ...
            lcd_line_1 = datetime.now().strftime("%I:%M:%S %p     \n") # Lazy display clear
        else:
