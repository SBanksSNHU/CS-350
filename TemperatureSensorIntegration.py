...
class ManagedDisplay():
    ...
    def __init__(self):
        ...
        ##
        self.lcd_rs = digitalio.DigitalInOut(board.D22) # Was 17
        self.lcd_en = digitalio.DigitalInOut(board.D27)
        self.lcd_d4 = digitalio.DigitalInOut(board.D5)
        self.lcd_d5 = digitalio.DigitalInOut(board.D16) # Was 6
        self.lcd_d6 = digitalio.DigitalInOut(board.D19) # Was 13
...
class TempMachine(StateMachine):
    ...
    ##
    redLight = LED(13) # Was 18
    blueLight = LED(12) # Was 23
